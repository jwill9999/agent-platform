...
Owner authorized drafting and backlog refinement; explicitly agreed to include a smaller in-app
status panel. No implementation agents have been assigned. Beads remains the scheduling authority.
...
No claim that all existing functionality is broken: the merged baseline passed 18 hosted desktop
scenarios and browser checks. Its new evidence covered reload approve/deny, completed-resume replay,
and a single pre-effect provider failure. It did not prove first-resume races, backend restart,
ambiguous tool outcomes or a Stop control.
...
Source baseline: feature/harness-backlog-review at `6b4d03e91ac0d2b1f6d765c5b4c5b108fb5bad59`.
