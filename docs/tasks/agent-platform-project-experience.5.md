...
- Show Project name, relevant folder/relative path, profile/status, onboarding state, and branch only
  where useful.
- Add quiet breadcrumbs or equivalent navigation for Home, Chat, Project, and any secondary surface.
...
- [ ] Breadcrumbs or equivalent quiet navigation exists for Home, Chat, Project, and secondary
      surfaces.
