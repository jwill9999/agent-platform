...
| `toolRateLimitPerMinute` | No       | Sliding-window rate limit per tool name (calls/min). Defaults to 30. Prevents a single tool from being hammered in rapid succession within one run.                                                                                                                         |
