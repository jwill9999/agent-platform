.PHONY: build rebuild up down restart reset new workspace-init workspace-clean-dry-run workspace-clean workspace-clean-force coding-runtime-verify seed logs logs-api logs-web status shell-api shell-web clean test lint typecheck format help
