...
export {
  ProjectModeSchema,
  ProjectDefaultAgentProfileSchema,
  WorkspaceProfileSchema,
  WorkspaceCapabilitySchema,
  WorkspaceProfileMetadataSchema,
  ProjectProfileSchema,
  ProjectCapabilitySchema,
  ProjectCapabilityStateSchema,
  ProjectOnboardingStateSchema,
  ProjectInstructionFileScopeSchema,
  ProjectAccessPolicyBlockReasonSchema,
  ProjectSubprojectScopeSchema,
  ProjectInstructionFileReferenceSchema,
  ProjectOnboardingAssessmentStatusSchema,
  ProjectOnboardingEvidenceKindSchema,
  ProjectOnboardingEvidenceFileSchema,
  ProjectOnboardingCommandKindSchema,
  ProjectOnboardingCommandSchema,
  ProjectOnboardingGapKindSchema,
  ProjectOnboardingGapSchema,
  ProjectOnboardingQuestionSchema,
  ProjectInstructionUpdateRecommendationSchema,
  ProjectInstructionUpdateSourceSchema,
  ProjectInstructionUpdateRiskSchema,
  ProjectInstructionUpdateStatusSchema,
  ProjectInstructionUpdateCandidateSchema,
  ProjectInstructionUpdateCandidateInputSchema,
  ...
  ProjectOnboardingDisplayContextSchema,
  ProjectOnboardingAssessmentSchema,
  ProjectOnboardingDraftSchema,
  ProjectOnboardingDialogueRoleSchema,
  ProjectOnboardingDialogueTurnSchema,
  ...
  ProjectOnboardingTransitionTriggerSchema,
  ...
  ProjectDesktopMetadataSchema,
  ProjectDesktopRecordSchema,
  ...
  ProjectGitHubRepositoryVisibilitySchema,
  ...
  ProjectGitCheckStatusSchema,
  ProjectGitCheckConclusionSchema,
  ProjectGitCheckRunSchema,
  ProjectGitChecksSummarySchema,
  ProjectGitChecksResultSchema,
  ProjectGitPullRequestStateSchema,
  ProjectGitPullRequestReviewDecisionSchema,
  ProjectGitPullRequestCheckSummarySchema,
  ProjectGitPullRequestSummarySchema,
  ProjectGitPullRequestsResultSchema,
  ProjectGitCreatePullRequestBodySchema,
  ProjectGitCreatePullRequestResultSchema,
  ProjectFileNodeSchema,
  ProjectFileTreeResultSchema,
  ProjectFileReadResultSchema,
  ProjectUpdateBodySchema,
  ProjectQuerySchema,
  GENERAL_CHAT_WORKSPACE_CAPABILITIES,
  CODING_PROJECT_WORKSPACE_CAPABILITIES,
  getDefaultWorkspaceCapabilitiesForProfile,
  getDefaultWorkspaceProfileForMode,
  deriveWorkspaceProfileMetadata,
  getDefaultAgentProfileForMode,
  getProjectAccessPolicy,
  transitionProjectOnboardingState,
  type ProjectMode,
  type ProjectDefaultAgentProfile,
  type WorkspaceProfile,
  type WorkspaceCapability,
  type WorkspaceProfileMetadata,
  type ProjectProfile,
  type ProjectCapability,
  type ProjectCapabilityState,
  type ProjectOnboardingState,
  type ProjectInstructionFileScope,
  type ProjectAccessPolicyBlockReason,
  type ProjectSubprojectScope,
  type ProjectInstructionFileReference,
  type ProjectOnboardingAssessmentStatus,
  type ProjectOnboardingEvidenceKind,
  type ProjectOnboardingEvidenceFile,
  type ProjectOnboardingCommandKind,
  type ProjectOnboardingCommand,
  type ProjectOnboardingGapKind,
  type ProjectOnboardingGap,
  type ProjectOnboardingQuestion,
  type ProjectInstructionUpdateRecommendation,
  type ProjectInstructionUpdateSource,
  type ProjectInstructionUpdateRisk,
  type ProjectInstructionUpdateStatus,
  type ProjectInstructionUpdateCandidate,
  type ProjectInstructionUpdateCandidateInput,
  type ProjectInstructionUpdateCandidateBody,
  type ProjectInstructionUpdateDecisionBody,
  type ProjectInstructionUpdateProposal,
  type ProjectOnboardingDisplayContext,
  type ProjectOnboardingAssessment,
  type ProjectOnboardingDraft,
  type ProjectOnboardingDialogueRole,
  type ProjectOnboardingDialogueTurn,
  type ProjectOnboardingDialogue,
  type ProjectOnboardingAnswerBody,
  type ProjectOnboardingReviewBody,
  type ProjectOnboardingApprovalDecision,
  type ProjectOnboardingRefreshResult,
  type ProjectOnboardingFixtureState,
  type ProjectOnboardingTransitionTrigger,
  type ProjectWorkspaceBinding,
  type ProjectAccessPolicy,
  type ProjectRecord,
  type ProjectCreateBody,
  type ProjectOpenBody,
  type ProjectDesktopRegistrationBody,
  type ProjectDesktopMetadata,
  type ProjectDesktopRecord,
  type ProjectDesktopRecentProjectsResult,
  type ProjectDesktopRegistrationResult,
  type ProjectBranchSummary,
  type ProjectBranchListResult,
  type ProjectBranchCheckoutBody,
  type ProjectGitWorkingTreeSummary,
  type ProjectGitRecentCommit,
  type ProjectGitStatusResult,
  type ProjectGitFileStatus,
  type ProjectGitChangedFile,
  type ProjectGitChangesResult,
  ...
  type ProjectGitPullRequestsResult,
  type ProjectGitCreatePullRequestBody,
  type ProjectGitCreatePullRequestResult,
  type ProjectFileNode,
  type ProjectFileTreeResult,
