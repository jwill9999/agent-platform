...
Archived from the previous oversized `session.md` on 2026-05-23. Keep `session.md` as the short rolling handoff and move older detail here when it would push the live handoff past its length budget.
