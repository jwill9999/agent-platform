  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'focus-visible:border-ring focus-visible:ring-ring/50 flex h-9 w-full items-center justify-between',
        'gap-2 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-xs',
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        'items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-none',
